 ...
 *
 * Accessible button for OAuth provider sign-in.
...
export function OAuthButton({
  ...
  // Custom styles for buttons to match branding while being cleaner
  const buttonStyles = {
    google: {
      bg: "white",
      color: "gray.700",
  ...
  return (
    <Button
      ...
      leftIcon={
        <Box as="span" display="flex" alignItems="center" fontSize="xl" mr={2}>
          {config.icon}
        </Box>
      }
